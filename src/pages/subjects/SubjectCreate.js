      ...
      <form
        onSubmit={async (e) => {
          ...
          try {
            ...
            const url = getApiUrl('/midland/users/subjects/create');
            ...
            if (!res.ok) {
              let errorMessage = `Failed to create subject (${res.status})`;
              try {
            ...
            const errorMsg = err.message || 'Failed to create subject';
            setError(errorMsg);
